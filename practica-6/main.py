...
rgb = rgb_pwm.RGB_PWM(33, 25, 26, 5000, False)
    ...
    <form>
        <table>
            <tbody>
                <tr>
                    ...
                    <td>
                        <input id="rinput" name="rinput" class="range redrange" type="range" max="99" value=" @@"""
        + r_value
        + """ @@">
        ...
        + """ </strong>
                ...
                <tr>
                    ...
                    <td>
                        <input id="ginput" name="ginput" class="range greenrange" type="range" max="99" value=" @@"""
        + g_value
        + """ @@">
        ...
        + """</strong>
                ...
                <tr>
                    ...
                    <td>
                        <input id="binput" name="binput" class="range bluerange" type="range" max="99" value=" @@"""
        + b_value
        + """ @@">
